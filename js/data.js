  ...
  },
  {
    ...
    translations: [
      ...
      { type: 'voice', status: 'done', author: 'SynthVoiceRu', rating: 4.7, version: '1.0 (SV2)', updated: '2024-12',
        ...
        links: '<a href="https://www.playground.ru/baldurs_gate_3/file/baldurs_gate_3_russkaya_ozvuchka_nejrosetevoj_dublyazh_v1_0_synthvoiceru-1698229" class="btn" target="_blank" rel="noopener">Playground (дубляж)</a>',
  ...
  },
  {
    ...
    translations: [
      { type: 'both', status: 'done', author: 'GamesVoice', rating: 4.9, version: '1.5', updated: '2026-09',
        ...
        body: '<p><strong>Что переведено:</strong> Текст, текстуры, полная профессиональная озвучка</p><p><strong>Актёры:</strong> Профессиональный состав студии, 143 актёра</p>',
        links: '<a href="https://www.playground.ru/hogwarts_legacy" class="btn" target="_blank" rel="noopener">Playground</a><a href="https://gamesvoice.ru/library" class="btn" target="_blank" rel="noopener">GamesVoice</a>',
  ...
  },
  {
    ...
    translations: [
      ...
      { type: 'voice', status: 'done', author: 'Сообщество / Nexus', rating: 4.0, version: '2.x', updated: '2025-05',
        ...
        body: '<p><strong>Что озвучено:</strong> Реплики NPC и боссов, нейросеть с ручной разметкой</p>',
        links: '<a href="https://www.nexusmods.com/eldenring" class="btn" target="_blank" rel="noopener">Nexus Mods</a>',
  ...
  },
  {
    ...
    translations: [
      { type: 'both', status: 'done', author: 'CD Projekt RED / Snowball', rating: 5.0, version: 'Next-Gen', updated: '2022-12',
        ...
        body: '<p><strong>Что переведено:</strong> Текст и полная озвучка, включая Hearts of Stone и Blood and Wine</p>',
        links: '<span class="link-muted">Уже в игре</span>' },
      { type: 'text', status: 'done', author: 'FFS Community', rating: 4.4, version: 'v9', updated: '2024-03',
        ...
        links: '<a href="https://www.playground.ru/the_witcher_3" class="btn" target="_blank" rel="noopener">Playground</a>' }
    ]
  },
  {
    id: 'starfield',
    ...
    translations: [
      { type: 'text', status: 'done', author: 'Сообщество', rating: 4.2, version: '2.x', updated: '2025-04',
        ...
        links: '<a href="https://www.playground.ru/starfield" class="btn" target="_blank" rel="noopener">Playground</a>' },
  ...
  },
  {
    ...
    translations: [
      ...
      { type: 'voice', status: 'done', author: 'Eloquence / Replika / SynthVoice', rating: 4.3, version: '25.08.26', updated: '2026-08',
        name: 'Гибридный дубляж',
        body: '<p><strong>Что озвучено:</strong> около 26 000 файлов</p>',
        links: '<a href="https://www.playground.ru/stalker_2" class="btn" target="_blank" rel="noopener">Playground</a>' }
    ]
  },
  {
    id: 'godofwar',
  ...
  },
  {
    ...
    translations: [
      ...
      { type: 'voice', status: 'done', author: 'Сообщество', rating: 3.9, version: '1.x', updated: '2025',
        ...
        links: '<a href="https://www.nexusmods.com/residentevil42023" class="btn" target="_blank" rel="noopener">Nexus Mods</a>' }
    ]
  },
  {
    id: 'horizon2',
    ...
    translations: [
      ...
      { type: 'voice', status: 'progress', author: 'Сообщество', rating: 0, version: '—', updated: '2025',
        ...
        body: '<p><strong>Статус:</strong> Ищите проекты на Playground</p>',
        links: '<a href="https://www.playground.ru/horizon_forbidden_west" class="btn" target="_blank" rel="noopener">Playground</a>' }
    ]
  },
  {
    id: 'alanswake2',
  ...
  },
  {
    ...
    translations: [
      ...
      { type: 'voice', status: 'done', author: 'Сообщество', rating: 3.8, version: '1.x', updated: '2025',
        ...
        links: '<a href="https://www.nexusmods.com/metaphorrefantazio" class="btn" target="_blank" rel="noopener">Nexus Mods</a>' }
    ]
  },
  {
    id: 'hades2',
    ...
    translations: [
      ...
      { type: 'voice', status: 'progress', author: 'Сообщество', rating: 0, version: '—', updated: '2026',
        name: 'Фанатская озвучка',
        body: '<p><strong>Статус:</strong> В разработке</p>',
        links: '<a href="https://t.me/hades2_ru" class="btn" target="_blank" rel="noopener">Telegram</a>' }
    ]
  },
  {
    id: 'rdr2',
