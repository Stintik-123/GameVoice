const games = [
  {
    ...
    desc: 'Официальный текстовый перевод и несколько фанатских озвучек для основного сюжета и Phantom Liberty.',
    translations: [
      {
        type: 'text',
        status: 'done',
        ...
        body: '<p><strong>Что переведено:</strong> Весь основной сюжет и Phantom Liberty (текст и субтитры)</p><p><strong>Примечание:</strong> Идёт в комплекте с игрой. Русская озвучка основной игры есть, DLC — только субтитры.</p>',
      ...
      },
      {
        ...
        body: '<p><strong>Статус:</strong> актуально на патч 2.3+</p><p><strong>Что озвучено:</strong> Полный дубляж DLC Phantom Liberty (гибрид: нейросеть и ручная доработка) плюс неозвученные фрагменты основной игры</p><p><strong>Совместимость:</strong> Steam, GOG</p>',
        ...
        install: '<details class="install"><summary>Краткая установка</summary><ol><li>Удалите предыдущие моды озвучки</li><li>Скачайте архив нужной версии с Playground</li><li>Распакуйте в папку с игрой по инструкции из архива</li><li>Запустите игру</li></ol></details>'
      },
      {
        type: 'voice',
        status: 'progress',
        ...
        body: '<p><strong>Статус:</strong> В активной разработке</p><p><strong>Что планируется:</strong> Полный профессиональный дубляж с актёрами основной русской локализации</p>',
      ...
      },
      {
        ...
        body: '<p><strong>Что озвучено:</strong> Основная игра и DLC в разном качестве</p><p><strong>Примечание:</strong> Быстрый вариант, качество ниже гибридного дубляжа DreamVoice</p>',
    ...
    translations: [
      {
        ...
        body: '<p><strong>Что переведено:</strong> Текст, текстуры, полная профессиональная озвучка</p><p><strong>Актёры:</strong> Профессиональный состав студии, 143 актёра</p><p><strong>Совместимость:</strong> Steam, актуальные патчи; v1.5 исправляет проблемы с серверами WB для РФ и РБ</p>',
  ...
  },
  {
    ...
    translations: [
      ...
      },
      {
        type: 'voice',
        status: 'done',
        author: 'Сообщество / Nexus',
        rating: 4.0,
        version: '2.x',
        updated: '2025-05',
        name: 'Нейро-дубляж и моды озвучки',
        body: '<p><strong>Что озвучено:</strong> Реплики NPC и боссов, нейросеть с ручной разметкой</p><p><strong>Особенности:</strong> Ищите актуальные моды на Nexus Mods</p>',
  ...
  },
  {
    ...
    desc: 'Эталон русской локализации: официальный полный дубляж и улучшенная версия для Next-Gen.',
    translations: [
      {
        type: 'both',
        status: 'done',
        author: 'CD Projekt RED / Snowball',
        rating: 5.0,
        version: 'Next-Gen',
        updated: '2022-12',
        name: 'Официальный полный дубляж',
        body: '<p><strong>Что переведено:</strong> Текст и полная озвучка, включая Hearts of Stone и Blood and Wine</p><p><strong>Примечание:</strong> В Next-Gen перезаписаны часть реплик и текстуры книг</p>',
        links: '<span class="link-muted">Уже в игре</span>'
      },
      {
        type: 'text',
        status: 'done',
        author: 'FFS Community',
        rating: 4.4,
        version: 'v9',
        updated: '2024-03',
  ...
  },
  {
    ...
    translations: [
      ...
      },
      {
        type: 'voice',
        status: 'progress',
        author: 'SynthVoiceRu / сообщество',
        rating: 3.8,
        version: 'beta',
        updated: '2025-06',
        name: 'Нейро-озвучка',
    ...
    translations: [
      {
        type: 'text',
        status: 'done',
        author: 'GSC / сообщество',
        rating: 4.0,
        name: 'Официальный и улучшенный текст',
        body: '<p><strong>Что переведено:</strong> Текст и субтитры, официально и патчами сообщества</p>',
        links: '<span class="link-muted">Уже в игре</span>'
      },
      {
        type: 'voice',
        status: 'done',
        author: 'Eloquence / Replika / SynthVoice',
        rating: 4.3,
        version: '25.08.26',
        updated: '2026-08',
        name: 'Гибридный дубляж (Replika + Eloquence + SynthVoice)',
        body: '<p><strong>Что озвучено:</strong> около 26 000 файлов: основа Replika, дополнения Eloquence Studio и SynthVoice</p>',
  ...
  },
  {
    ...
    desc: 'Официальный текст и субтитры. Профессиональной русской озвучки нет.',
    translations: [
      {
        type: 'text',
        status: 'done',
        ...
        rating: 4.9,
        name: 'Официальный перевод Rockstar',
        body: '<p><strong>Что переведено:</strong> Полный текст, интерфейс и субтитры</p><p><strong>Примечание:</strong> Идёт в комплекте с игрой. Озвучка — только английская</p>',
        links: '<span class="link-muted">Уже в игре</span>'
      }
    ]
  }
